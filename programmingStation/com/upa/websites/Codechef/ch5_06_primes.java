...
public class ch5_06_primes {
	...
	void run() {
		...
		System.out.printf("%b\n", this.isPrime(2147483647)); // 10-digits prime
		System.out.printf("%b\n", this.isPrime(136117223861L)); // not a prime,
																// 104729*1299709

		// second part: prime factors
		List<Integer> res = this.primeFactors(2147483647); // slowest,
															// 2147483647 is a
															// prime
		for (int i : res) {
			System.out.printf("> %d\n", i);
