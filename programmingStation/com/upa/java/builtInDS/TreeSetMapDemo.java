...
public class TreeSetMapDemo {
	public static void main(String[] args) {
		...
		/*
		 * john 78 billy 69 andy 80 steven 77 felix 82 grace 75 martin 81
		 */
		mapper.put("john", 78);
		used_values.add(78);
		mapper.put("billy", 69);
		...
		// returns [69, 75] (these two are before 77 in the inorder traversal of
		// this BST)
		System.out.println(used_values.headSet(77));
