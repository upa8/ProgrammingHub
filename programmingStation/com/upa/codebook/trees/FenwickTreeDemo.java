 ...
 * values.
 *
 * Space complexity for fenwick tree is O(n) Time complexity to create fenwick
 * tree is O(nlogn) Time complexity to update value is O(logn) Time complexity
 * to get prefix sum is O(logn)
 *
 * References
 * http://www.geeksforgeeks.org/binary-indexed-tree-or-fenwick-tree-2/
 * https://www.topcoder.com/community/data-science/data-science-
 * tutorials/binary-indexed-trees/ http://en.wikipedia.org/wiki/Fenwick_tree
 */
public class FenwickTreeDemo {
	...
	public static void main(String args[]) {
		...
		FenwickTreeDemo ft = new FenwickTreeDemo();
