...
public class GraphAdjacencyMatrix extends MyScanner {
	...
	public static void main(String[] args) throws Exception {
		...
		// So we have to run our loop to add those edges and their weight into
		// our
		// adj matrix
		...
		for (int i = 0; i < m; i++) {
			...
			// Also , f and e should not be same because if they are same then
			// there is edge from same vertext to the same vertext
